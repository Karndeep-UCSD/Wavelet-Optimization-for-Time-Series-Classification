...
clear classToSave classToRmv char key data_temp labels_temp dataStruct rmvIndex p


%% Start of function
%inside funciton, outsie cross val loop
numData = 48; %p-1
folds = 1:numData;
...
fun = @(T)evalWavelet(T,testData,testLabels,trainData, trainLabels);
lb = [0,0,0,0];
...
function error = evalWavelet(T,testData,testLabels,trainData, trainLabels)
    % make wavelets
